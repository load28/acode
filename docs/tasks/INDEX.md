...
| [TASK-0010](TASK-0010-react-review-performance-benchmark.md) | 실제 React 저장소(excalidraw) 대상 코드리뷰 성능 벤치마크 | done | 2026-07-16 | 2026-07-16 | `benchmarks/bench_review_mech.py`, `benchmarks/bench_review_full.py` |
